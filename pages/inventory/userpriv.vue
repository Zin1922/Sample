...
<template>
    <main>
  <body class="body-userpriv">
        <center>
          <h2 class="h2">Inventory</h2>
          </center>
      <form class="table-formuserpriv">
        <div class=""  >
          <div v-for="(product, index) in products" :key="product._id">
            <ul>
              <li>
                  ...
                  <table class="table">
                    <tr class="nuxt-textuserpriv">
                      <th>Name</th>
                      <th >Stock Quantity</th>
                      <th >Price</th>
                    </tr>
              
                    <tr class="nuxt-textuserpriv" width="123px">
                      <td width="123px">
                        {{ product.title }}
                      </td>
                      <td>
                      ...
                      <td ><nuxt-link type="button" :to="`/products/${product._id}`" class="nuxt-textuserpriv" >Update</nuxt-link>  </td>
                      <td> <span type="button" class="" @click="onDelete( index)"> Delete </span> </td>
                    </tr>
                 <!--   <tr>
                      <td></td>
                      <td></td>
      ...
      <footer>
      <center>
        <span type="button" class="btn-styleuserpriv" style="width: calc(100%-50%)">Add product</span>


        <nuxt-link type="button" to="/" class="btn-styleuserpriv" style="width: calc(100%-50%)">Log Out</nuxt-link>
      </center>
      </footer>
  </body>
    </main>
